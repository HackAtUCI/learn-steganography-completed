...
def encode_IDAT(chunk_data, encode_buf):
    ...
    for i in range(0, height):
        ...
        # TO-DO: Set filter type and scanline_start
        filter_type = None
        # print(filter_type)
        scanline_start = None
        ...
        while bits != None and j < width * 3 + 1:
            ...
            # TO-DO: Toggle bit position of message in secret.png and see effects
...
def encode():
    ...
    #  print(width, height, bit_depth, color)
